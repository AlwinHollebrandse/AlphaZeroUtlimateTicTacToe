...
Based on the pytorch version of OthelloNNet by SourKream and Surag Nair.
'''

class UltimateTicTacToeNNet(nn.Module):
    def __init__(self, game, args):
        ...
        super(UltimateTicTacToeNNet, self).__init__()
        print('yo: args.num_channels: ' + str(args.num_channels))
        ...
        self.conv4 = nn.Conv3d(args.num_channels, args.num_channels, 1, stride=1) # was 3
        ...
        self.fc1 = nn.Linear(args.num_channels*(self.board_x-4)*(self.board_y-4)*(self.board_z-4), 1024) # TODO 3-4 is -1...correct? why do -4?
